  ...
  return (
    <div className="p-8 mt-20">
      <div className="flex justify-between items-center mb-10">
        ...
        <label className="cursor-pointer bg-black text-white px-6 py-4 rounded-2xl flex items-center gap-3 hover:bg-red-800">
          <Upload size={24} />
      ...
      {uploading && <p className="text-red-700 mb-4">Upload en cours...</p>}
        ...
        {images.map((img) => (
          <div key={img._id} className="relative group rounded-3xl overflow-hidden border border-stone-200">
            ...
            <button
              ...
              className="cursor-pointer absolute top-3 right-3 bg-red-600 text-white p-2 rounded-full opacity-0 group-hover:opacity-100 transition"
            >
              <Trash2 size={18} />
            </button>
          </div>
